...
namespace DynamicsApiToDatabase.Services
{
    ...
    public class SpeedWmsDataService
    {
        ...
        private async Task<List<SpeedWmsBLData>> GetBLHeadersAsync(SqlConnection connection)
        {
            ...
            AND OPE_REDO = 'SO004143' -- Filtrer par OPE_REDO spécifique
            --SO003118,SO003139,SO003140,SO004143
            ORDER BY OPE_KEYU";
                ...
                // 🧪 LOG DE TEST
                _logger.LogWarning($"🧪 FILTRE TEST ACTIF : Seulement OPE_ALPHA17='PP000448' - {blHeaders.Count} BL trouvé(s)");
